package xyz.dylanlogan.ancientwarfare.vehicle.config;
...
@Config(modid = AncientWarfareVehicles.MOD_ID, filename = "ancientwarfare\\AncientWarfareVehicle")
  ...
  private static class EventHandler {
    ...
    public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
      if (event.modID.equals(AncientWarfareVehicles.MOD_ID)) {
        //ConfigurationManager.save(); todo: update this
